...
// On déclare la variable globale reCAPTCHA
declare var grecaptcha: any;

@Component({
  selector: 'app-dpo-contact',
  standalone: true,
  templateUrl: './dpo-contact.component.html',
  styleUrls: ['./dpo-contact.component.scss'],
  imports: [CommonModule, FormsModule]
})
export class DpoContactComponent implements OnInit {
  ...
  siteKey = '6Lf1GegqAAAAABOuGDe9DvE4sZFb-8ZDMXhstKXl'; // Clé publique reCAPTCHA
